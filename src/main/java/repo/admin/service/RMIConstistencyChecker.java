...
public class RMIConstistencyChecker implements ConsistencyChecker {
    public boolean checkConsistency(String consistencyCheckerId, RepoItem repoItem) {
        ...
        try {
            ...
            consistent = remotePersonConsistencyChecker.checkConsistency(repoItem);
        } catch (Exception e) {
    ...
    private RemotePersonConsistencyChecker lookupRemotePersonConsistencyChecker() throws NamingException {
        ...
        final String viewClassName = RemotePersonConsistencyChecker.class.getName();
        // let's do the lookup
        RemotePersonConsistencyChecker remotePersonConsistencyChecker = (RemotePersonConsistencyChecker) context.lookup("ejb:" + appName + "/" + moduleName
